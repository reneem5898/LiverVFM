function plotVF_2D(uVF, U, nodes, outDir)
...
subplot(2,2,2)
scatter(nodes(:,2),nodes(:,3), bubbleSZ, real(uVF_y), 'filled')
cbh = colorbar;
...
subplot(2,2,1)
scatter(nodes(:,2),nodes(:,3), bubbleSZ, real(u_y), 'filled')
cbh = colorbar;
...
subplot(2,2,4)
scatter(nodes(:,2),nodes(:,3), bubbleSZ, imag(uVF_y), 'filled')
view([0 90])
cbh = colorbar;
...
subplot(2,2,3)
scatter(nodes(:,2),nodes(:,3), bubbleSZ, imag(u_y), 'filled')
cbh = colorbar;
...
saveas(FH, sprintf('%s/uVF_Y_complex_2D.png', outDir))
